...
#Note by Patrick Simmons
#This code was pulled from the Requests project on GitHub for use in MailTask.
#The license of this code is Apache 2.0.
#That is compatible with the license of MailTask, which is GPLv3.
